...
/** Configurations for {@link KingbaseDataSource}. */
public class KingbaseDataSourceOptions {

    public static final ConfigOption<String> HOSTNAME =
            ConfigOptions.key("hostname")
                    .stringType()
                    .noDefaultValue()
                    .withDescription("IP address or hostname of the Kingbase database server.");
    public static final ConfigOption<Integer> PG_PORT =
            ConfigOptions.key("port")
                    .intType()
                    .defaultValue(54321)
                    .withDescription("Integer port number of the Kingbase database server.");
    ...
    public static final ConfigOption<String> USERNAME =
            ConfigOptions.key("username")
                    ...
                    .noDefaultValue()
                    .withDescription(
                            "Name of the Kingbase database to use when connecting to the Kingbase database server.");
    ...
    public static final ConfigOption<String> PASSWORD =
            ConfigOptions.key("password")
                    ...
                    .noDefaultValue()
                    .withDescription(
                            "Password to use when connecting to the Kingbase database server.");
    ...
    public static final ConfigOption<String> TABLES =
            ConfigOptions.key("tables")
                    ...
                    .noDefaultValue()
                    .withDescription(
                            "Table names of the Kingbase tables to monitor. Regular expressions are supported. "
    ...
    public static final ConfigOption<String> DECODING_PLUGIN_NAME =
            ConfigOptions.key("decoding.plugin.name")
                    ...
                    .withDescription(
                            "The name of the Kingbase logical decoding plug-in installed on the server.\n"
    ...
    public static final ConfigOption<Duration> CONNECT_TIMEOUT =
            ConfigOptions.key("connect.timeout")
                    ...
                    .withDescription(
                            "The maximum time that the connector should wait after trying to connect to the Kingbase database server before timing out.");
    ...
    public static final ConfigOption<Integer> CONNECT_MAX_RETRIES =
            ConfigOptions.key("connect.max-retries")
                    ...
                    .defaultValue(3)
                    .withDescription(
                            "The max retry times that the connector should retry to build Kingbase database server connection.");
    ...
    public static final ConfigOption<String> SCAN_STARTUP_MODE =
            ConfigOptions.key("scan.startup.mode")
                    ...
                    .withDescription(
                            "Optional startup mode for Kingbase CDC consumer, valid enumerations are "
    ...
    // ----------------------------------------------------------------------------
    @org.apache.flink.cdc.common.annotation.Experimental
    ...
    public static final ConfigOption<String> TABLES_EXCLUDE =
            ConfigOptions.key("tables.exclude")
                    ...
                    .noDefaultValue()
                    .withDescription(
                            "Table names of the Kingbase tables to Exclude. Regular expressions are supported. "
                                    + "It is important to note that the dot (.) is treated as a delimiter for database and table names. "
                                    + "If there is a need to use a dot (.) in a regular expression to match any character, "
                                    + "it is necessary to escape the dot with a backslash."
                                    + "eg. db0.\\.*, db1.user_table_[0-9]+, db[1-2].[app|web]_order_\\.*");
