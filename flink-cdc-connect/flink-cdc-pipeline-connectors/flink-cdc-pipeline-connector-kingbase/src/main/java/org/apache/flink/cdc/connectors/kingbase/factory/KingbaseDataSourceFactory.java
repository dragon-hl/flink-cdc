...
import org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSource;
import org.apache.flink.cdc.connectors.kingbase.utils.KingbaseSchemaUtils;
...
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.CHUNK_KEY_EVEN_DISTRIBUTION_FACTOR_LOWER_BOUND;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.CHUNK_KEY_EVEN_DISTRIBUTION_FACTOR_UPPER_BOUND;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.CHUNK_META_GROUP_SIZE;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.CONNECTION_POOL_SIZE;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.CONNECT_MAX_RETRIES;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.CONNECT_TIMEOUT;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.DECODING_PLUGIN_NAME;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.HEARTBEAT_INTERVAL;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.HOSTNAME;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.METADATA_LIST;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.PASSWORD;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.PG_PORT;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SCAN_INCREMENTAL_CLOSE_IDLE_READER_ENABLED;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_BACKFILL_SKIP;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_CHUNK_KEY_COLUMN;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_CHUNK_SIZE;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SCAN_INCREMENTAL_SNAPSHOT_UNBOUNDED_CHUNK_FIRST_ENABLED;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SCAN_LSN_COMMIT_CHECKPOINTS_DELAY;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SCAN_SNAPSHOT_FETCH_SIZE;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SCAN_STARTUP_MODE;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SERVER_TIME_ZONE;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SLOT_NAME;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SPLIT_KEY_EVEN_DISTRIBUTION_FACTOR_LOWER_BOUND;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.SPLIT_KEY_EVEN_DISTRIBUTION_FACTOR_UPPER_BOUND;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.TABLES;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.TABLES_EXCLUDE;
import static org.apache.flink.cdc.connectors.kingbase.source.KingbaseDataSourceOptions.USERNAME;
...
/** A {@link Factory} to create {@link KingbaseDataSource}. */
@Internal
public class KingbaseDataSourceFactory implements DataSourceFactory {

    private static final Logger LOG = LoggerFactory.getLogger(KingbaseDataSourceFactory.class);

    public static final String IDENTIFIER = "kingbase";
    ...
    public DataSource createDataSource(Context context) {
        ...
        // Force the decoding plugin name into debezium properties to ensure it reaches
        // Debezium's PostgresConnectorConfig correctly (Kingbase only supports decoderbufs)
        configMap.put("debezium.plugin.name", pluginName);
        Optional<String> databaseName = getValidateDatabaseName(tables);

        PostgresSourceConfigFactory configFactory =
                PostgresSourceBuilder.PostgresIncrementalSource.<org.apache.flink.table.data.RowData>builder()
                        .hostname(hostname)
                        .port(port)
        ...
        List<TableId> tableIds = KingbaseSchemaUtils.listTables(configFactory.create(0), null);
        ...
        return new KingbaseDataSource(configFactory, readableMetadataList);
    }
    ...
    private List<PostgreSQLReadableMetadata> listReadableMetadata(String metadataList) {
        ...
        throw new IllegalArgumentException(
                String.format(
                        "[%s] cannot be found in kingbase metadata.",
    ...
    private Optional<String> getValidateDatabaseName(String tables) {
        ...
        for (String tableName : tableNames) {
            ...
            checkState(
                    isValidKingbaseDbName(currentDbName),
                    String.format("%s is not a valid Kingbase database name", currentDbName));
            if (dbName == null) {
    ...
    /** Validate if the database name conforms to Kingbase naming conventions. */
    private boolean isValidKingbaseDbName(String dbName) {
        // Kingbase database name conventions:
