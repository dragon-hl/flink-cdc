...
/** A utility class for converting Kingbase types to Flink types. */
public class KingbaseTypeUtils {

    // Kingbase-specific OIDs that differ from standard PostgreSQL OIDs
    private static final int KINGBASE_TINYINT_OID = 8100;
    private static final int KINGBASE_DATE_OID = 7944;
    private static final int KINGBASE_TIMESTAMP_OID = 7954;
        ...
        switch (nativeType) {
            ...
            default:
                ...
                throw new UnsupportedOperationException(
                        String.format(
                                "Doesn't support Kingbase type '%s', Kingbase oid '%d' yet",
