...
/** Event deserializer for {@link KingbaseDataSource}. */
@Internal
public class KingbaseEventDeserializer extends DebeziumEventDeserializationSchema {
    ...
    public KingbaseEventDeserializer(DebeziumChangelogMode changelogMode) {
        super(new KingbaseSchemaDataTypeInference(), changelogMode);
    }

    public KingbaseEventDeserializer(
    ...
    protected Object convertToString(Object dbzObj, Schema schema) {
        // the Geometry datatype in Kingbase will be converted to
