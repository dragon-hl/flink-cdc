...
public class PostgresSourceConfigFactory extends JdbcSourceConfigFactory {
    ...
    private boolean includePartitionedTables = false;
    ...
    /** Whether to include partitioned tables. */
    public void includePartitionedTables(boolean includePartitionedTables) {
