...
public class PostgresDialect implements JdbcDataSourceDialect {
    ...
    public JdbcConnection openJdbcConnection(JdbcSourceConfig sourceConfig) {
        ...
        // Use the 3-arg constructor which uses FACTORY (direct non-pooled connection via
        // jdbc:kingbase8:// and com.kingbase8.Driver). Avoid the 5-arg constructor with
        // JdbcConnectionFactory which creates HikariCP proxied connections — HikariCP's
        // ProxyConnection.unwrap() (v4.0.3) calls delegate.unwrap(KbConnection.class)
        // without checking isInstance() first, and the Kingbase JDBC driver 8.6.1's
        // KbConnection.unwrap(KbConnection.class) throws SQLException, causing
        // "Cannot unwrap to com.kingbase8.jdbc.KbConnection" during TypeRegistry init.
