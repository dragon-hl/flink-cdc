...
public class PostgreSQLTableFactory implements DynamicTableSourceFactory {
    ...
    private static final String SCAN_STARTUP_MODE_VALUE_EARLIEST_OFFSET = "earliest-offset";
    ...
    private static StartupOptions getStartupOptions(ReadableConfig config) {
        ...
        switch (modeString.toLowerCase()) {
            ...
            case SCAN_STARTUP_MODE_VALUE_EARLIEST_OFFSET:
            ...
            default:
                throw new ValidationException(
                        String.format(
                                ...
                                SCAN_STARTUP_MODE_VALUE_EARLIEST_OFFSET,
